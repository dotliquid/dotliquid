...
namespace DotLiquid
{
	public static class StandardFilters
	{
		...
		/// <summary>
		/// Remove duplicate Elemnts of a Array
		/// Optional a Property with wich to determine uniqueness
		/// </summary>
		/// <param name="input"></param>
		/// <param name="property"></param>
		/// <returns></returns>
		public static IEnumerable Uniq(object input, string property = null)
		{
			var list = ((IEnumerable)input).Cast<object>();
			if (property == null)
			{
			...
			{
				var knownKeys = new HashSet<object>();
		...
		/// <summary>
		/// Returns the String of a UrlDecoded String
		/// </summary>
		/// <param name="input"></param>
		/// <returns></returns>
		...
		/// <summary>
		/// Reverses a String or IEnumerable
		/// </summary>
		...
		public static object Reverse(object @object)
		{
			...
			{
				return ((IEnumerable)@object).Cast<object>().Reverse();
			}
