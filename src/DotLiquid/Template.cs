...
namespace DotLiquid
{
    ...
    public class Template
    {
        ...
        public static Template ParseTokens(List<string> tokens)
        {
            Template template = new Template();
            template.ParseInternal(tokens);
            return template;
        }
        ...
        public static List<string> GetReusableTokens(string source)
        {
        ...
        internal Template ParseInternal(string source)
        {
            ...
            return ParseInternal(GetReusableTokens(source));
        }
