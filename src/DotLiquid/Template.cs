...
namespace DotLiquid
{
    ...
    public class Template
    {
        ...
        /// <returns></returns>
        public string Render(bool restrictTypes = true)
        {
            return Render(new RenderParameters(), restrictTypes);
        }
        ...
        /// <param name="restrictTypes"></param>
        /// <returns></returns>
        public string Render(Hash localVariables, bool restrictTypes = true)
        {
        ...
        /// <param name="parameters"></param>
        /// <param name="restrictTypes"></param>
        public void Render(Stream stream, RenderParameters parameters, bool restrictTypes = true)
        {
            // Can't dispose this new StreamWriter, because it would close the
            // passed-in stream, which isn't up to us.
            StreamWriter streamWriter = new StreamWriter(stream);
            RenderInternal(streamWriter, parameters, restrictTypes);
            streamWriter.Flush();
        }
        ...
        /// </summary>
        private void RenderInternal(TextWriter result, RenderParameters parameters, bool restrictTypes)
        {
            if (Root == null)
                return;
            ...
            parameters.Evaluate(this, out context, out registers, out filters, restrictTypes);
            ...
            {
                // Render the nodelist.
                Root.Render(context, result, restrictTypes);
            }
            finally
            {
